        ...
        <div class="container text-left mt-3">
            <div class="mx-6 mb-5">
                <div class="article px-5">
                    <h1 class="text-center mb-4">Le titre de l'article</h1>
                ...
                <div class="row mx-0">
                    <div class="col-6 com-left mt-4">
                        <h4><img src="img/center.svg" alt="Photo de profil de x" width="40px" height="40px" class="mr-3">Le pseudo</h4>
                        <p>Le commentaire 1</p>
                    </div>
                    <div class="col-6">
                    </div>
                    <!-- Deuxième articles -->
                    ...
                    <div class="col-6 com-right mt-4">
                        <h4><img src="img/right.svg" alt="Photo de profil de x" width="40px" height="40px" class="mr-3">Le pseudo</h4>
                        <p>Le commentaire 2</p>
                    </div>
                </div>
            </div>
            <hr class="mx-6 px-5">
